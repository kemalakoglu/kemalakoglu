...
namespace Core.Infrastructure.Domain.Context.Migrations
{
    ...
    [Migration("20200408102016_InitialData_v.1.2")]
    partial class InitialData_v12
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Infrastructure.Domain.Aggregate.User.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Core.Infrastructure.Domain.Aggregate.RefTypeValue.RefValue", b =>
                {
                    b.HasOne("Core.Infrastructure.Domain.Aggregate.RefTypeValue.RefType", "RefType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Infrastructure.Domain.Aggregate.User.ApplicationUser")
                        .WithMany()
